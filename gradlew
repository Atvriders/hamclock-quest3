...
# Outdated leftovers -- args should be in DEFAULT_JVM_OPTS or GRADLE_OPTS
#   GRADLE_OPTS
...
#     temporary files to preserve quoting/whitespace handling correctly.
#   * Put the rest of the arguments in "$@" -- note, again, that we use "$@"
#     to collect them in a way that preserves whitespace correctly.
...
#
# With -n://github.com/gradle/gradle/pull/21078
eval "set -- $(
